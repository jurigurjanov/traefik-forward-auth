...
import (
	...
	"github.com/jurigurjanov/traefik-forward-auth/internal/provider"
...
type Config struct {
	...
	Scopes                 string               `long:"scopes" env:"SCOPES" default:"profile email" description:"Scopes to request from provider"`
